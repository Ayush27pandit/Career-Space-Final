...
function JobPostForm() {
      ...
      <>
        ...
        <div className="md:p-5 bg-black h-[100vh] w-[100vw] text-white flex items-center justify-center">
          <div className="text-center">
            ...
            <Button onClick={() => navigate('/jobsearchform')} className="bg-blue-400 rounded-lg p-4 text-xl">
  ...
  return (
    <>
      ...
      <Link  className="" to={"/quizcreate"}>
      <Button className="h-[50px]  ml-4 text-md mb-8" variant={'secondary'}>
        Create quizes for potential candidates
      </Button>
      </Link>
